...
import { Home, Users, GitBranch, Calendar, MessageCircle, UserCircle, LogOut, SlidersHorizontal, Menu, X, HelpCircle, BookOpen } from 'lucide-react';
  ...
  return (
    <div className={styles.layout}>
      ...
      >
        ...
        <Link to="/biblioteca" className={styles.menuLink} onClick={() => setIsMenuOpen(false)}>
