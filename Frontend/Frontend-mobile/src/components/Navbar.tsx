...
import { notificationsStore } from "@/src/features/notifications/store/notifications.store";
import { notificationsService, notificationObserver } from "@/src/features/notifications/services";
      ...
      >
        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              style={styles.menuItem}
              onPress={() => navigateTo("/(tabs)/forum")}
            >
              <Ionicons name="help-circle-outline" size={22} color="#D9B97E" />
